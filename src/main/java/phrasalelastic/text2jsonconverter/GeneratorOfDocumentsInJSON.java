...
public class GeneratorOfDocumentsInJSON {
    ...
    public static String generateJSON(Language detectedLanguage, List<String> polishText, List<String> englishText, List<String> polishTextConcepts, List<String> englishTextConcepts) {
